...
function default_1(_a) {
    var layers = _a.layers, onClick = _a.onClick, _b = _a.shadowOpacity, shadowOpacity = _b === void 0 ? 0.4 : _b, _c = _a.rotationAngleDegrees, rotationAngleDegrees = _c === void 0 ? 15 : _c, _d = _a.hideShadow, hideShadow = _d === void 0 ? false : _d, _e = _a.parallaxMultiplier, parallaxMultiplier = _e === void 0 ? 0.03 : _e, _f = _a.dropShadowSpread, dropShadowSpread = _f === void 0 ? 45 : _f, _g = _a.dropShadowDepth, dropShadowDepth = _g === void 0 ? 45 : _g, otherProps = __rest(_a, ["layers", "onClick", "shadowOpacity", "rotationAngleDegrees", "hideShadow", "parallaxMultiplier", "dropShadowSpread", "dropShadowDepth"]);
    ...
    var onMouseDown = function () {
        setState(__assign(__assign({}, state), { isSelecting: true }));
    };
        ...
        return layers.map(function (layer, i) {
            var props = {
                style: {
                    ...
                    width: '100%',
                    height: '100%',
                    transform: "translateX(" + i * parallaxMultiplier * dx + "px) translateY(" + i * parallaxMultiplier * dy + "px)",
                },
                key: i,
            };
    ...
    return (react_1.default.createElement(Root, __assign({ onMouseEnter: onMouseEnter, onMouseMove: onMouseMove, onMouseLeave: onMouseLeave, onTouchStart: onTouchStart, onTouchMove: onTouchMove, onTouchEnd: onTouchEnd, onTouchStartCapture: onTouchStart, onTouchEndCapture: onTouchEnd, onMouseDown: onMouseDown, onMouseUp: onMouseUp, isOver: state.isOver, ref: rootRef }, otherProps),
        react_1.default.createElement(react_motion_1.Motion, { style: styles }, function (interpolated) { return (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(react_measure_1.default, { bounds: true, onResize: onMeasure }, function (_a) {
                ...
                return (react_1.default.createElement(IconContainer, { scale: interpolated.scale, rx: interpolated.rx, ry: interpolated.ry, ref: measureRef },
                    renderLayers(interpolated),
                    react_1.default.createElement(Shine, { sx: interpolated.sx, sy: interpolated.sy, sb: interpolated.sb }),
                    react_1.default.createElement(Shade, { hx: interpolated.hx, hy: interpolated.hy, hb: interpolated.hb })));
            }))); })));
}
